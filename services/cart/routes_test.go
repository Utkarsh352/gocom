...
func TestCartServiceHandler(t *testing.T) {
	...
	t.Run("should fail to checkout if the cart items do not exist", func(t *testing.T) {
		payload := models.CartCheckoutPayload{
			Items: []models.CartCheckoutItem{
...
func (m *mockProductStore) GetProductByID(productID int) (*models.Product, error) {
	return &models.Product{}, nil
}

func (m *mockProductStore) GetProducts() ([]*models.Product, error) {
	return []*models.Product{}, nil
}

func (m *mockProductStore) CreateProduct(product models.CreateProductPayload) error {
	return nil
}

func (m *mockProductStore) GetProductsByID(ids []int) ([]models.Product, error) {
...
func (m *mockOrderStore) CreateOrder(order models.Order) (int, error) {
	return 0, nil
}

func (m *mockOrderStore) CreateOrderItem(orderItem models.OrderItem) error {
	return nil
}
