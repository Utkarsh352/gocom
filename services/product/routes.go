...
import (
	...
	"github.com/utkarsh352/gocom/services/auth"
	"github.com/utkarsh352/gocom/utils"
)
...
func NewHandler(store models.ProductStore, userStore models.UserStore) *Handler {
